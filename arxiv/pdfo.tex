...
The current release (Version~2.0.2) of \gls{pdfo} supports Python and MATLAB, with more languages to be covered in the future.
...
The value of~$\radlb[k]$ can be regarded as an indicator for the current \emph{accuracy} of the algorithm.
...
Our experiments are carried out in double precision based on the Python version of \gls{pdfo}~2.0.2.
...
Finally, the authors thank the referees for their suggestions, which have substantially improved the software and manuscript.

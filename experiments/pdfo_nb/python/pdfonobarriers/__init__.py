# -*- coding: utf-8 -*-
"""Management of the importable functions of pdfonobarriers.
...
# >>> print(pdfonobarriers.__author__)
# >>> ...
...
if not __PDFO_SETUP__:
    ...
    from ._pdfo import pdfonobarriers
    from . import tests
    ...
    __all__ = ['OptimizeResult', 'Bounds', 'LinearConstraint',
               ...
               'uobyqa', 'pdfonobarriers', 'tests', 'testpdfo']

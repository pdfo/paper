#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests pdfonobarriers on a few VERY simple problems.

Notes
-----
Do NOT follow the syntax here when you use pdfonobarriers. This file is written for testing purpose, and it uses quite atypical
syntax. See rosenbrock.py for an illustration about how to use pdfonobarriers.
...
class TestPDFO(unittest.TestCase):
    SOLVERS = ['uobyqa', 'newuoa', 'bobyqa', 'lincoa', 'cobyla', 'pdfonobarriers']
    RELEASE = True
    ...
    def setUp(self):
        """Initializes the pdfonobarriers tests.
        ...
        The Hong Kong Polytechnic University.
        """
        self.module_pdfo = __import__('pdfonobarriers')

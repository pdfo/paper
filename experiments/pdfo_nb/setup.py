...
import pdfonobarriers  # noqa
import pdfonobarriers._min_dependencies as min_deps  # noqa
...
def configuration(parent_package='', top_path=None):
    ...
    config.add_subpackage('pdfonobarriers', str(BASE_DIR / 'python' / 'pdfonobarriers'))
...
def setup_package():
    metadata = dict(
        ...
        version=pdfonobarriers.__version__,

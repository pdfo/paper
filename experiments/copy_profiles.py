...
def copy_all_figures():
    ...
    for page in [2, 4]:
        ...
        extract_pdf_page("archives/perf/noisy/1-50/rerun-10_type-relative_level-1e-08/perf-bfgs_cg_newuoa-unconstrained.pdf", page, f"../figures/perf-noisy-bfgs_cg_pdfo-50-8-{page}.pdf")
        extract_pdf_page("archives/perf/noisy/1-50/rerun-10_type-relative_level-1e-10/perf-bfgs_cg_newuoa-unconstrained.pdf", page, f"../figures/perf-noisy-bfgs_cg_pdfo-50-10-{page}.pdf")

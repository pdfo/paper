...
def create_all_figures():
    for prec in range(1, 10):
        ...
        create_figure("archives/perf/nan/1-50/rerun-1_rate-0.01/perf-bfgs_cg_pdfo_pdfo-(no-barrier)-unconstrained.csv", f"perf-nan-bfgs_cg_pdfo-50-1-0.01-{prec}.pdf", prec)
        create_figure("archives/perf/nan/1-50/rerun-10_rate-0.01/perf-bfgs_cg_pdfo_pdfo-(no-barrier)-unconstrained.csv", f"perf-nan-bfgs_cg_pdfo-50-10-0.01-{prec}.pdf", prec)

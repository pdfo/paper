...
the same way as calling \texttt{minimize} except that \pdfofun does not accept derivative arguments.
...
When invoking the~\pdfofun function, the user can specify the solver to call in the backend.
...
In addition to the \pdfofun function, PDFO also provides functions named~\cobylafun,

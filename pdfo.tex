...
However, if the user does not \modified{specify a solver} or chooses a solver that is incapable of solving the problem~(e.g., \gls{uobyqa} cannot solve constrained problems), then \pdfofun selects the solver as follows.
\begin{enumerate}
...
It was also supported by The Hong Kong Polytechnic University under project P0009767, \modified{and
the CAS-Croucher Funding Scheme for ``CAS AMSS-PolyU Joint Laboratory of Applied
Mathematics: Nonlinear Optimization Theory, Algorithms and Applications''}.

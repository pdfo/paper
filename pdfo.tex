...
We compare \gls{pdfo} with \gls{rs} and \gls{tpe}, two optimizers for hyperparameter tuning
...
scikit-learn.\footnote{\url{https://scikit-learn.org/stable/modules/generated/sklearn.svm.SVC.html}.}
...
We have presented the package \gls{pdfo} for Python and MATLAB, which aims at simplifying the use of

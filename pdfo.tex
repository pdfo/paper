...
\begin{table}[ht]
    ...
    \label{tab:htdata}
    \centering
    \begin{tabular}{lcS[table-format=5]S[table-format=5]}
        \toprule
...
Tables~\ref{tab:splice}--\ref{tab:ijcnn1} present the results for this experiment, where \#$P$ denotes the number of \modified{evaluations of} the function~$P$ and ``Time'' \modified{is} the computing time for obtaining~$(\bar{C}, \bar{\gamma})$.

...
problem~\eqref{eq:svc} being handled by the SVC class of the Python machine learning package scikit-learn.\footnote{\url{https://scikit-learn.org/stable/modules/generated/sklearn.svm.SVC.html}.}
...
general hyperparameter tuning problems, which is unlikely the case. Indeed, \gls{pdfo} cannot be
applied unless the hyperparameters are continuous.

...
% Redefine the subsection and paragraphs headings to be bold.
\makeatletter
...
\begin{abstract}
    ...
    We also present experiments on \gls{pdfo} to demonstrate its stability under noise, tolerance of failures in function evaluations, and potential in solving certain hyperparameter optimization problems.
...
We perform the comparison on~158 unconstrained problems with~$n \le 50$ from the CUTEst~\cite{Gould_Orban_Toint_2015} problem set using PyCUTEst~1.4~\cite{Fowkes_Roberts_Burmen_2022}.

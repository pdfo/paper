...
Meanwhile, it needs to maintain the well-poisedness of the interpolation set, or equivalently, the
well conditioning of the interpolation problem~\cite{Sauer_Xu_1995,Conn_Scheinberg_Vicente_2009b}.
...
spanned by the current step and the corresponding gradient of~$\objm[k]$.

...
\usepackage[bb=dsfontserif,cal=cm]{mathalpha}
\usepackage{siunitx}
...
functions that make the interpolation problem~\eqref{eq:undqitp}--\eqref{eq:leastchange}
easy to solve~(see~\cite[\S~3]{Powell_2004b})
}

...
We do not include the result with larger values of~$\sigma$, as \gls{cg} and \gls{bfgs} will barely
...
The same as what is shown in~\cite[\S~2]{Shi_Etal_2022}, the performance of finite-difference methods is encouraging when there is no noise, yet much more care is needed when the problems are noisy.

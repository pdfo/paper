...
\begin{enumerate}
    ...
    \Gls{pdfo} takes care of failures in the evaluation of the objective or constraint functions when NaN values are returned.
...
\gls{pdfo} can tolerate failures of function evaluations 
